...
var sc = new SmoothieChart({ millisPerPixel: 1000, labels: { precision: 0 }, grid: { millisPerLine: 100000, verticalSections: 10 }, yRangeFunction: function(r) { return { min: 0, max: 10*Math.ceil(0.11 * r.max) } } }); var line1 = new TimeSeries(); var line2 = new TimeSeries(); var line3 = new TimeSeries(); \
